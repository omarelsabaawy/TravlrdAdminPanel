...
const DeleteAdmin: React.FC<DeleteAdminProps> = ({ isDeleteAdminModalOpen, onClose, adminId }) => {
  const [loading, setLoading] = useState<boolean>(false);
  const router = useRouter();
  
  const handleDeleteAdmin = async (event: any) => {
  ...
  return (
    <>
      ...
      <div
        ...
        tabIndex={-1}
        aria-hidden="true"
        className={`${isDeleteAdminModalOpen ? 'flex items-center justify-center' : 'hidden'
          ...
          <div className="relative p-4 w-full max-w-md max-h-full">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <p className="mb-4 text-gray-500 dark:text-gray-300">Are you sure you want to delete this Admin?</p>
